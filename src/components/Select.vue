...
<script type="text/babel">
  ...
  export default {
    ...
    props: {
       ...
       * an action, rather than using :value.sync to retrieve the selected value.
       * @type {Function}
    ...
    watch: {
      ...
      /**
       * Maybe reset the mutableValue when mutableOptions change.
      ...
      /**
       * Always reset the mutableValue when the multiple prop changes.
       * @param  {Boolean} val
       * @return {void}
       */
      multiple (val) {
    ...
    /**
     * Clone props into mutable values, attach any event listeners.
     */
    created () {
